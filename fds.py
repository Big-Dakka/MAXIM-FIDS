...
def fds_get_datasets(data, load_train=True, load_test=True):
    ...
    path = data_dir
    print("*****",path)
    dataset_path = os.path.join(path, "FDS10")
    ...
    if not is_dir:
        ...
        if not is_dir:
            ...
            path = os.getcwd()
            dataset_path = os.path.join(path, "archive", "images")
            print(dataset_path)
            is_dir = os.path.isdir(dataset_path)
            if not is_dir:
            ...
            # create directories
            dataset_home = os.path.join(data_dir, "FDS10")
            ...
            src_directory = os.path.join(path, "archive", "images")
            for file in listdir(src_directory):
                src_folder = os.path.join(src_directory, file)
                folder = file
                for file in listdir(src_folder):
                    src = os.path.join(path, "archive", "images", folder, file)
    ...
    training_data_path = os.path.join(data_dir, "FDS10")
    training_data_path = os.path.join(training_data_path, "train")

    test_data_path = os.path.join(data_dir, "FDS10")
